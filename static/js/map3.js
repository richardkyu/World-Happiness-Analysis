...
function create_2016_map_data(){
    ...
    style: function (feature) {
      ...
      for(i=0;i<data_test_2016.length;i++){
        if(feature.properties.ADMIN === data_test_2016[i].Country){
          Generosity_color = getColorFreedom(data_test_2016[i]['Generosity'])
  ...
  freedom_for_2016 = L.geoJson(world_borders, {
    style: function (feature) {
      ...
      for(i=0;i<data_test_2016.length;i++){
        if(feature.properties.ADMIN === data_test_2016[i].Country){
          Freedom_color = getColorFreedom(data_test_2016[i]['Freedom'])
  ...
  life_expectancy_for_2016 = L.geoJson(world_borders, {
    style: function (feature) {
      ...
      for(i=0;i<data_test_2016.length;i++){
        if(feature.properties.ADMIN === data_test_2016[i].Country){
        //console.log(data_test_2016[i]['Health (Life Expectancy)'])
        LE_color = getColorLE(data_test_2016[i]['Health (Life Expectancy)'])
  ...
  family_for_2016 = L.geoJson(world_borders, {
    style: function (feature) {
      ...
      for(i=0;i<data_test_2016.length;i++){
        if(feature.properties.ADMIN === data_test_2016[i].Country){
        //console.log(data_test_2016[i]['Health (Life Expectancy)'])
        Family_color = getColorFamily(data_test_2016[i]['Family'])
  ...
  GDP_for_2016 = L.geoJson(world_borders, {
    ...
    style: function (feature) {
      ...
      for(i=0;i<data_test_2016.length;i++){
        if(feature.properties.ADMIN === data_test_2016[i].Country){
        //console.log(data_test_2016[i]['Economy (GDP per Capita)'])
        GDP_color = getColorGDP(data_test_2016[i]['Economy (GDP per Capita)'])
        }
      }
      //Fill in all the variables
      return {
